...
1. **JSON Mode** Your site pages will be stored in JSON at your server. Tipue Search will use AJAX to access it and render search result. You need [Content in JSON plugin](https://github.com/getpelican/pelican-plugins) to use this mode.
