          ...
          if (standard) {
            ...
            for (var i = 0; i < tipuesearch.pages.length; i++) {
              ...
              for (var f = 0; f < d_w.length; f++) {
                ...
                if (d_w[f].match("^-")) {
                  ...
                  if (
                    tipuesearch.pages[i].title.search(pat) != -1 ||
                    tipuesearch.pages[i].text.search(pat) != -1 ||
                    tipuesearch.pages[i].tags.search(pat) != -1
                  ) {
                    score = 0;
                  }
                }
            ...
            for (var i = 0; i < tipuesearch.pages.length; i++) {
              ...
              if (score != 0) {
                for (var e = 0; e < tipuesearch_weight.weight.length; e++) {
                  if (
                    tipuesearch.pages[i].url == tipuesearch_weight.weight[e].url
                  ) {
                    score += tipuesearch_weight.weight[e].score;
                  }
                }
              ...
              for (var i = 0; i < tipuesearch_related.Related.length; i++) {
                if (d == tipuesearch_related.Related[i].search) {
                  ...
                  ront +=
                    ...
                    r_d +
                    '">' +
                    tipuesearch_related.Related[i].related +
                    "</a>, ";
                  f++;
                }
              }
